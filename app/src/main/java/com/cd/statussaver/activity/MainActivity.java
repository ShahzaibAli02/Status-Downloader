...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void initViews() {
        ...
        binding.rvCaptionStatus.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        binding.rvUnsavedNumber.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        binding.rvIFaces.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
